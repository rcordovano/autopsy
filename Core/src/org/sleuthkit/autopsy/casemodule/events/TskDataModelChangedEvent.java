...
//     * published when Sleuth Kit Data Model objects for a case are added,
//     * updated, or deleted.
//     *
//     * Note that both the unique numeric IDs (TSK object IDs, case database row
//     * IDs, etc.) of the objects and the objects themselves are passed in
//     * separately. THis is necessary because this class
//     *
//     * @param eventName          The event name.
//     * @param dataModelObjectIds The unique numeric IDs (TSK object IDs, case
//     *                           database row IDs, etc.) of the Sleuth Kit Data
//     *                           Model objects that are the subject of this
//     *                           application event.
//     * @param dataModelObjects   The Sleuth Kit Data Model objects that are the
//     *                           subject of this application event. Pass null if
//     *                           the objects have been deleted.
//     */
//    protected TskDataModelChangedEvent(String eventName, List<Long> dataModelObjectIds, List<T> dataModelObjects) {
//        super(eventName, null, null);
//        this.dataModelObjectIds = new ArrayList<>();
//        this.dataModelObjectIds.addAll(dataModelObjectIds);
//        isDeletionEvent = dataModelObjects != null;
//        if (isDeletionEvent) {
